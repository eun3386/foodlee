...
public class FoodtruckMysqlDAOImpl implements IFoodtruckDAO {
	...
	private static final String SQL_UPDATE_FOODTRUCK = "update foodtrucks set foodtruck_img_path=?, foodtruck_name=?, "
			+ "foodtruck_main_menu=?, foodtruck_location=?, foodtruck_muni=?, "
			+ "foodtruck_gu_code=?,foodtruck_operation_hour=?, " + "seller_foodtruck_coordinate=?";
	private static final String SQL_DELETE_FOODTRUCK = "delete from foodtrucks where foodtruck_name = ?";
