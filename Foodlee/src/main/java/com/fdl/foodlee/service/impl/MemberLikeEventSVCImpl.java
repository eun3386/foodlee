...
@Service
public class MemberLikeEventSVCImpl implements IMemberLikeEventSVC {

	@Autowired
	@Qualifier("mbLikeEvMybatis")
	IMemberLikeEventDAO mleDao;
	
	@Override
	public Map<String, Object> processMemberLike(int tgSr, int sesMb) {
		String oldLikeMemberIds = mleDao.currentLikeMembers(tgSr);
		Map<String, Object> pMap = new HashMap<String, Object>();
		pMap.put("event_id", tgSr);
		...
		case LIKE_MB_FOUND_ONE: // 취소
			...
			r = mleDao.memberLikeRemove(pMap);
		...
		//
		if (r)
			rMap.put("cntLikes", mleDao.countLikeEvent(tgSr));
	...
	public int countLikeMembers(int tgSr) {
		return mleDao.countLikeEvent(tgSr);
	}
