...
<div id = "gu-list-wrap">
    <table id="gu-list-table" border="0">
        <caption id="gu-truck-info"><img src="resources/css/imgs/foodleee-face.png" class="face"> <span id="gu">성동구</span> 푸드트럭 정보<i class="fas fa-times" style="color: firebrick"></i></caption>
        <thead>
            <tr>
