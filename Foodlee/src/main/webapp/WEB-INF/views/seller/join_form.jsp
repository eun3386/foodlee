    ...
    <form action="${pageContext.request.contextPath}/seller/join.fdl" method="post">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="companyRN1" name="companyRN1" maxlength="3" size="6" required>&nbsp;-&nbsp;
                    <input type="text" id="companyRN2" name="companyRN2" maxlength="2" size="3" required>&nbsp;-&nbsp;
                    <input type="text" id="companyRN3" name="companyRN3" maxlength="5" size="10" required>
                </td>
            </tr>
