...
<div id="join_form">
    <form action="${pageContext.request.contextPath}/seller/join.fdl" method="post" enctype="multipart/form-data">
        ...
        <table id="join_table" class="table_edit" border="0">
            ...
            <tr>
                <th class="lb"><label for="companyRN1">*사업자등록번호</label></th>
                <td>
                    <input class="input" type="text" id="companyRN1" name="companyRN1" maxlength="3" size="11" required>&nbsp;&nbsp;-&nbsp;
                    <input class="input" type="text" id="companyRN2" name="companyRN2" maxlength="2" size="8" required>&nbsp;&nbsp;-&nbsp;
                    <input class="input" type="text" id="companyRN3" name="companyRN3" maxlength="5" size="15" required>
                </td>
            </tr>
