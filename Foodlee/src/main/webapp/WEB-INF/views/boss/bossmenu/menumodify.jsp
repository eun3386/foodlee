...
<%-- <link href="<%=application.getContextPath()%>/resource/css/main.css" type="text/css" rel="stylesheet">
<link href="<%=application.getContextPath()%>/resource/css/reset.css" type="text/css" rel="stylesheet"> --%>
<style type="text/css">
...
<div>
	...
	<div id="menumo">
	<nav id="menumo-header" class="navbar navbar-light bg-light justify-content-between">
	<form class="form-inline">
		<a class="menumodify" href="#">메뉴등록</a> 
		<a class="menuregister" href="#">메뉴수정</a>
		<a class="storeinfo" href="#">가게정보</a>
	...
	<table border="0">
		...
		<button>삭제</button><button>수정</button><button>취소</button>
