            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12"><!-- col-sm-12 col-md-6 col-lg-4 //col-sm-12 col-md-3 col-lg-3 -->
                        <div class="card">
                            ...
                            <form class="mt-3 float-left">
                            
                                    <div class="form-group">
                                    	<h4 class="card-subtitle">요일</h4>
                                        <input type="text" class="form-control" disabled value="시작시간">
                                        <input type="text" class="form-control" disabled value="마감시간">
                                    </div>
                                </form>
                                <form class="mt-3 float-left">
                                    <div class="form-group">
                                    	<h4 class="card-subtitle"><code>일</code></h4>
                                ...
                                <form class="mt-3 float-left">
                                    <div class="form-group">
                                    	<h4 class="card-subtitle"><code>토</code></h4>
                                        <input type="time" class="form-control" value="22:33:00">
                                        <input type="time" class="form-control" value="22:33:00">
                                    </div>
                                </form>
